 ...
 * sd_tmp_short: Amplitude of short-term variation (SD of another normal distribution)                                    *
...
int main (void)
{
    ...
    // temperaure distribution (environmental factors)
        ...
        // Normal distribution
            ...
            double sd_tmp_long=	 	    0.5+ sqrt(200.0);    // Amplitude of long-term variation (SD of a normal distribution)
            double sd_tmp_short=        0.5+ sqrt(200.0);   // Amplitude of short-term variation (SD of a normal distribution)
            double u1, u2;
	...
	// Initialization
        ...
        fprintf(out,"N1\tN2\ttime\tenv\n");
        fprintf(out,"%lf\t%lf\t%lf\t%lf\n",p[i_1],p[i_2],t, mean_tmp);
    ...
    for (i=1; i<= T/deltat; i++){
        ...
        // Progression of time
            ...
            t+= deltat;
        // Print
            if(i%200==0) fprintf(out,"%lf\t%lf\t%lf\t%lf\n",p[i_1],p[i_2],t, curr_tmp);
